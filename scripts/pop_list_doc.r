...
# Description:
#   Describes the population arrays in pop_list.
#
# ------------------------------------------------------------------------------------------------------------------->
# Author: Russ Jones
# Created: Feb 7, 2025
...
# ------------------------------------------------------------------------------------------------------------------->
#
#' List of population arrays called pop_list
#'
#'  A named list of arrays with population figures. The list contains population data for the decennial censuses,
...
#'  the DFW metroplex, and other large urban counties in Texas. The zcta array is the exception and only provides
#'  the total population by zip code. Available arrays and their sources include:
...
#'
#'  Functions are provided to retrieve the population actually needed such as [county_population()]. Any of the arrays
#'  in pop_list or those returned from [county_population()] or from pop_list can be coerced to a data frame or tibble
#'  using the generic [as.data.frame()] or [as.tibble()] functions respectively.
#'
...
#' for  All  and Hispanic , but not stratified by race, e.g., Black-Hispanic, White-Hispanic etc. are  not available.
#'
...
#'  * fips is a factor of the state and county fips codes  (not included as of Feb 10, 2025)
