...
#'  *  texas.estimates are the July 1st estimates for years 2001 through 2023. The
...
#' have been standardized to use the same field names and where possible the same categorical values. However, there are
